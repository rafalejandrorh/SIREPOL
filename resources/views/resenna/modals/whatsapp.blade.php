            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        ' || Motivo de Reseña: '.$resenna->motivo_resenna->valor.' || Tez: '.$resenna->tez->valor.' || Contextura: '.$resenna->contextura->valor.' || Coordenadas de Aprehensión: '.$resenna->coordenadas_aprehension.' || Funcionario Aprehensor: '
