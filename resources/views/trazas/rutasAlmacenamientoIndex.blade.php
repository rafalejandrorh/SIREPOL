...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading"><b>Trazas de Rutas de Almacenamiento</b></h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(array('route' => 'traza_rutasAlmacenamiento.index','method' => 'GET')) !!}
                            <div class="row">
                                    ...
                                    <table class="table table-striped mt-2 display dataTable table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">{{$ruta->user->users}}</td>
                                                <td class="sorting_1">{{$ruta->acciones->valor}}</td>
                                                <td class="sorting_1">{{ date('d/m/Y H:i:s', strtotime($ruta->created_at)) }}</td>
                                                <td>
                                                    <a class="btn btn-info" href="{{ route('traza_rutasAlmacenamiento.show', $ruta->id) }}"><i class='fa fa-eye'></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
    ...
    @include('trazas.modals.filtro', ['filtro' => 'traza_rutasAlmacenamiento.index'])
</section>
@endsection