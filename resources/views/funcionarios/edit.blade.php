                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('id_genero', $genero, $funcionario->person->genero, array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('id_jerarquia', $jerarquia, $funcionario->jerarquia->valor, array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-3">
                                <div class="form-group">
